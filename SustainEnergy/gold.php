      ...
      <!-- End of Navbar -->
        ...
        <div class="container p-4 col-md-5">
            <div class="card text-black shadow" style="text-align: center; border-radius: 10px; padding-bottom: 2%; background-color: #BFD8D8;">  
                <h1 style="padding-top: 2%">Gold Certificate</h1>
            </div>
        </div>
        <!-- End of Header -->
        ...
        <div id="certificate" class="container col-md-8">
            <div class="card text-black shadow" style="text-align: center; border-radius: 10px; padding-bottom: 2%; background-color: #BFD8D8; border: 4px solid #FFD700;">  
                <h1>Certificate of Achievement</h1>
                <hr style='border-top: 2px dotted #000;'>

                <p>This is to certify that <strong><?php echo $org ?></strong></p>
                <p>has successfully achieved a <strong>GOLD</strong> certification from SustainEnergy for their commitment to sustainable practices.</p>
